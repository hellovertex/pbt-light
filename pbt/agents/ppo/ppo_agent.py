...
class PPOAgent(tf_agent.TFAgent):
    ...
    @property
    def importance_ratio_clipping(self):
        return self._importance_ratio_clipping

    @importance_ratio_clipping.setter
    def importance_ratio_clipping(self, value):
        self._importance_ratio_clipping = value

    @property
    def entropy_regularization(self):
        return self._entropy_regularization

    @entropy_regularization.setter
    def entropy_regularization(self, value):
        self._entropy_regularization = value

    @property
    def value_pred_loss_coef(self):
        return self._value_pred_loss_coef

    @value_pred_loss_coef.setter
    def value_pred_loss_coef(self, value):
        self._value_pred_loss_coef = value

    @property
    def kl_cutoff_factor(self):
        return self._kl_cutoff_factor

    @kl_cutoff_factor.setter
    def kl_cutoff_factor(self, value):
        self._kl_cutoff_factor = value

    @property
    def kl_cutoff_coef(self):
        return self._kl_cutoff_coef

    @kl_cutoff_coef.setter
    def kl_cutoff_coef(self, value):
        self._kl_cutoff_coef = value
